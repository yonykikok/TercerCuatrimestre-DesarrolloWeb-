 ...
 * @apiParam {Callable} next  The next middleware callable.
   ...
   */
	public function VerificarUsuario($request, $response, $next) {
		...
		var_dump(AutentificadorJWT::ObtenerPayLoad($arrayConToken));
		die();
			...
			{				
				...
				{					
					if(isset($_POST['tipo']))
					{
						...
						$datos = array('usuario' => $_POST['usuario'],'password' => $_POST['password'], 'tipo' => $_POST['tipo']);
						
						$usuario=usuario::TraerUnUsuarioPorLogin($datos['usuario'],$datos['password']);
						//var_dump($usuario);
