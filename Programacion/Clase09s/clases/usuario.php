...
class usuario
{
	...
	{
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select id as id, usuario as usuario, password as password, tipo as tipo from usuarios where usuario = '$auxUsuario' and password= '$password'");
			$consulta->execute();
			$usuarioBuscado= $consulta->fetchObject('usuario');
