<?php
    ...
    {                //verificamos que exista el proveedor en el archivo, de lo contrario no se puede modificar
        if(proveedor::verificarExistenciaDelProveedor(proveedor::LeerProveedoresJson($path),$_POST['id']))
        {            
            if(isset($_POST['nombre']))
            {
                if(isset($_POST['email']))
                {
                    ...
                    { 
                        ...
                        proveedor::ModificarProveedor($_POST["id"],$proveedorActual);
        ...
        {
            echo "el ID no existe en la lisa de proveedores";
        }
    }
    else
    {
