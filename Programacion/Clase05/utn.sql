...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2019 a las 00:08:06
...
SELECT SUM(envio.Cantidad) FROM `envios` as envio WHERE envio.Numero="102" and pNumero=1$$
...
UPDATE `productos` as prod,`envios` as envio SET `Tamaño`= "Mediano" WHERE envio.Cantidad >=300 and envio.pNumero=prod.pNumero and prod.tamaño="Chico"$$
...
('Caramelos', 1, 1.5, 'Chico'),
('Cigarrillos', 2, 45.89, 'Mediano'),
('Gaseosa', 3, 97.5, 'Grande');
